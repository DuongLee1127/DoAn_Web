                    ...
                    <div class="row wrapper-header align-items-center">
                        ...
                        <div class="col-xl-3 col-md-4 col-6">
                            <a href="index.html" class="logo-header">
                                <img src="{{ asset('client/images/logo/logo.png') }}" alt="logo" class="logo">
                            </a>
                        </div>
                                                    ...
                                                    <div class="collection-item hover-img">
                                                        <div class="collection-inner">
                                                            <a href="shop-men.html" class="collection-image img-style">
                                                                <img class="lazyload" data-src="{{ asset('client/images/collections/collection-1.jpg') }}" src="{{ asset('client/images/collections/collection-1.jpg') }}" alt="collection-demo-1">
                                                            </a>
                                                    ...
                                                    <div class="collection-item hover-img">
                                                        <div class="collection-inner">
                                                            <a href="shop-women.html" class="collection-image img-style">
                                                                <img class="lazyload" data-src="{{ asset('client/images/collections/collection-2.jpg') }}" src="{{ asset('client/images/collections/collection-2.jpg') }}" alt="collection-demo-1">
                                                            </a>
                                                            <div class="collection-content">
                                                            ...
                                                            <div class="swiper-wrapper">
                                                                    ...
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <a href="#" class="product-img">
                                                                                <img class="lazyload img-product" data-src="{{ asset('client/images/products/orange-1.jpg') }}" src="{{ asset('client/images/products/orange-1.jpg') }}" alt="image-product">
                                                                                <img class="lazyload img-hover" data-src="{{ asset('client/images/products/white-1.jpg') }}" src="{{ asset('client/images/products/white-1.jpg') }}" alt="image-product">
                                                                            </a>
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            ...
                                                                            <ul class="list-color-product">
                                                                                <li class="list-color-item color-swatch active">
                                                                                    ...
                                                                                    <img class="lazyload" data-src="{{ asset('client/images/products/orange-1.jpg') }}" src="{{ asset('client/images/products/orange-1.jpg') }}" alt="image-product">
                                                                                </li>
                                                                                <li class="list-color-item color-swatch">
                                                                                    <span class="tooltip">Black</span>
                                                                                    <span class="swatch-value bg_dark"></span>
                                                                                    <img class="lazyload" data-src="{{ asset('client/images/products/black-1.jpg') }}" src="{{ asset('client/images/products/black-1.jpg') }}" alt="image-product">
                                                                                </li>
                                                                                <li class="list-color-item color-swatch">
                                                                                    <span class="tooltip">White</span>
                                                                                    <span class="swatch-value bg_white"></span>
                                                                                    <img class="lazyload" data-src="{{ asset('client/images/products/white-1.jpg') }}" src="{{ asset('client/images/products/white-1.jpg') }}" alt="image-product">
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <div class="product-img">
                                                                                <img class="lazyload img-product" data-src="{{ asset('client/images/products/white-3.jpg') }}" src="{{ asset('client/images/products/white-3.jpg') }}" alt="image-product">
                                                                                <img class="lazyload img-hover" data-src="{{ asset('client/images/products/white-4.jpg') }}" src="{{ asset('client/images/products/white-4.jpg') }}" alt="image-product">
                                                                            </div>
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <div class="product-img">
                                                                                <img class="lazyload img-product" data-src="{{ asset('client/images/products/white-2.jpg') }}" src="{{ asset('client/images/products/white-2.jpg') }}" alt="image-product">
                                                                                <img class="lazyload img-hover" data-src="{{ asset('client/images/products/pink-1.jpg') }}" src="{{ asset('client/images/products/pink-1.jpg') }}" alt="image-product">
                                                                            </div>
                                                                            <div class="list-product-btn">
                                                                                <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                                                    <span class="icon icon-bag"></span>
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            ...
                                                                            <ul class="list-color-product">
                                                                                <li class="list-color-item color-swatch active">
                                                                                    <span class="tooltip">White</span>
                                                                                    <span class="swatch-value bg_white"></span>
                                                                                    <img class="lazyload" data-src="{{ asset('client/images/products/white-2.jpg') }}" src="{{ asset('client/images/products/white-2.jpg') }}" alt="image-product">
                                                                                </li>
                                                                                <li class="list-color-item color-swatch">
                                                                                    <span class="tooltip">Pink</span>
                                                                                    <span class="swatch-value bg_purple"></span>
                                                                                    <img class="lazyload" data-src="{{ asset('client/images/products/pink-1.jpg') }}" src="{{ asset('client/images/products/pink-1.jpg') }}" alt="image-product">
                                                                                </li>
                                                                                <li class="list-color-item color-swatch">
                                                                                    <span class="tooltip">Black</span>
                                                                                    <span class="swatch-value bg_dark"></span>
                                                                                    <img class="lazyload" data-src="{{ asset('client/images/products/black-2.jpg') }}" src="{{ asset('client/images/products/black-2.jpg') }}" alt="image-product">
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <div class="product-img">
                                                                                <img class="lazyload img-product" data-src="{{ asset('client/images/products/brown-2.jpg') }}" src="{{ asset('client/images/products/brown-2.jpg') }}" alt="image-product">
                                                                                <img class="lazyload img-hover" data-src="{{ asset('client/images/products/brown-3.jpg') }}" src="{{ asset('client/images/products/brown-3.jpg') }}" alt="image-product">
                                                                            </div>
                                                                            <div class="size-list">
                                                                                <span>S</span>
                                                                                <span>M</span>
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            ...
                                                                            <ul class="list-color-product">
                                                                                <li class="list-color-item color-swatch active">
                                                                                    ...
                                                                                    <img class="lazyload" data-src="{{ asset('client/images/products/brown-2.jpg') }}" src="{{ asset('client/images/products/brown-2.jpg') }}" alt="image-product">
                                                                                </li>
                                                                                <li class="list-color-item color-swatch">
                                                                                    <span class="tooltip">White</span>
                                                                                    <span class="swatch-value bg_white"></span>
                                                                                    <img class="lazyload" data-src="{{ asset('client/images/products/white-5.jpg') }}" src="{{ asset('client/images/products/white-5.jpg') }}" alt="image-product">
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                            ...
                            <div class="tf-col-content">
                                ...
                                <div class="tf-search-hidden-inner">
                                    <div class="tf-loop-item">
                                        <div class="image">
                                            <a href="product-detail.html">
                                                <img src="{{ asset('client/images/products/white-3.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="content">
                                    ...
                                    <div class="tf-loop-item">
                                        <div class="image">
                                            <a href="product-detail.html">
                                                <img src="{{ asset('client/images/products/white-2.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="content">
                                    ...
                                    <div class="tf-loop-item">
                                        <div class="image">
                                            <a href="product-detail.html">
                                                <img src="{{ asset('client/images/products/white-1.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="content">
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <div class="tf-minicart-recommendations-item">
                                                        <div class="tf-minicart-recommendations-item-image">
                                                            <a href="product-detail.html">
                                                                <img src="{{ asset('client/images/products/white-3.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="tf-minicart-recommendations-item">
                                                        <div class="tf-minicart-recommendations-item-image">
                                                            <a href="product-detail.html">
                                                                <img src="{{ asset('client/images/products/white-2.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="tf-minicart-recommendations-item-infos flex-grow-1">
...
<div class="progress-wrap">
    ...
    <script type="text/javascript" src="{{ asset('client/js/swiper-bundle.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('client/js/carousel.js') }}"></script>
    <script type="text/javascript" src="{{ asset('client/js/bootstrap-select.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('client/js/lazysize.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('client/js/count-down.jsv') }}"></script>
    <script type="text/javascript" src="{{ asset('client/js/wow.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('client/js/multiple-modal.js') }}"></script>
